...
\begin{figure*}
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includestandalone[mode=buildnew, width=0.8\linewidth]{drawings/eqnetworks/eqnetworks}
    \caption{An artificial neural network with connections and weights.}\label{fig:eqnetwork}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includestandalone[mode=buildnew, width=0.8\linewidth]{drawings/eqnetworks/eqnetwork2}
