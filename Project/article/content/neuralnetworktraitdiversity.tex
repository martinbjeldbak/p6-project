...
\end{equation*}
%
where \nemptyspeciesf{i} is the set of non-empty species with respect to random input $\ran_i$, and \indset{} denotes set of all individuals in the population. The \dia{} $D$ (that is, the actual diversity) is then calculated as the average of all \ransetl{} $D_i$ values by
%
\[
