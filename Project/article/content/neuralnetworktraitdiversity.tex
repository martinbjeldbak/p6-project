...
\end{equation*}
%
where $\lvert S_j(R_i)\rvert$ is the total number of individuals of the $j$th species, with respect to random input $R_i$. %, and $k$ is the number of non-empty species. 
