...
%
\[
  \forall j \forall h \in \set{1,2,\dots,y} \left(b_j \rightarrow \left(o_j \geq o_h\right)\right)
\]
%
...
\]
%
which has a complexity of \bigO{k m}, where $k$ is the number of non-empty species and $m$ is the amount random inputs ($\lvert R \rvert$).
