...
%Neural networks can be used to solve many types of problems, e.g., classification and decision problems. 
We assume that every neural network in a population will have the same architecture. That is, the number of neurons, the size of each layer, and how neurons are connected is the same.
