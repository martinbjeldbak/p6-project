...
\]
The first $u-1$ bits each represent an increasing sequence of powers of two, and the final bit $u$ negates the entire value if set. The value is finally normalized to the range $[-5, 5]$.
