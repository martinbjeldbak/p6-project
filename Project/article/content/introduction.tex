...
Ideally, the GA will make individuals procreate to form offspring that combines the best traits from both its parents. Intuitively, the combination of these traits constitutes a better solution to the given problem. The fitness value of an individual indicates how adequately it solves the problem in question.
