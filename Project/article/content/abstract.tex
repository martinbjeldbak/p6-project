\begin{abstract}
This paper presents \dia, a phenotypic diversity measurement for neural network representations of genetic programs. It it an extension of the Simpsons Diversity Index known from ecology.

%Motivation:
%Why do we care about the problem and the results?
Avoiding low diversity in a genetic algorithm's population is crucial for finding a global optimal solution. When diversity is overlooked, premature convergence is achieved. This most likely leads to local optimal solutions.

%Problem statement:
%What problem are you trying to solve?
Another factor, which is important for maintaining a high diversity is how individuals are replaced in the population. We present a method in which we maintain high diversity and use our own replacement rule, which contributes to a high diversity, without being too slow in the search for the optimum.

%Approach:
%How did you go about solving or making progress on the problem?
Many studies have been conducted in this field of research, and we compare our method against other results, which aimed to solve the same problem.\citpls

%Results:
%What's the answer? 
Succesful or failure?
