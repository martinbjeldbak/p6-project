...
Experiments are conducted with \dia{} and two other well-known diversity measures, fitness-based diversity measurement and the Hamming distance, which is a genotypic diversity measure.
...
%Results:
%What's the answer? 
Our results show that the fitness-based measure is unreliable, because the data shows irregular spikes when the experiments where performed. \dia{} and the Hamming distance showed a stabil progression in measuring the diversity. The data shows some form of correspondance between these two measures.
