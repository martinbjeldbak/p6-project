...
If a neuron is given the value $0$ on all of its inputs, most transfer functions will only allow that neuron to output $0$ as well.
...
The bias value of a neuron is added to the sum of inputs it receives, before finally applying the transfer function.
Thus, if a neuron receives only $0$'s as input, it will output the value obtained by applying the transfer function to its bias value.
