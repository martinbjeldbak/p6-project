\begin{figure*}
  ...
  \end{subfigure}
  \ref{initMutMeasures}
  \caption{Average diversity for each diversity measure on each data set over intervals of initial mutation. Each point represents the average of \num{100} runs.}\label{fig:initial-mutation}
\end{figure*}
