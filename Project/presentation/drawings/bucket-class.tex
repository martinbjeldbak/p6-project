\begin{tikzpicture}
  ...
  \node[bucket] (b2) [below of=o2, node distance=1.75cm] {$2 < o_1 < 4$};
  \node[bucket] (b1) [below left of=o2, node distance=2.5cm] {$o_1\leq2$};
  \node[bucket] (b3) [below right of=o2, node distance=2.5cm] {$4 \leq o_1$};
